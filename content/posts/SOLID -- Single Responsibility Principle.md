...
The result is a set of classes that are much more concise and cleaner. Developers looking to fix or update employee-related code will not have to deal with (and risk breaking) the email-related code and vice-versa.
